...
import {Card, Form, InputNumber, Select, Button, Tooltip, message, Empty,
} from 'antd';
      ...
      <div className="w-9/12 mx-auto flex flex-col gap-12">
        <div className="text-center">
          ...
          <p>
            ...
            provident quia pariatur veritatis iusto deleniti nisi, nesciunt
            asperiores, rerum quis ab nulla error autem distinctio neque eius
            omnis hic fugiat.
          </p>
        </div>
