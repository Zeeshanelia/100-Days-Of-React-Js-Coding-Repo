  ...
  return (
    <div className='bg-gray-200 h-screen flex items-center justify-center'>
      <div className='bg-white rounded-xl p-4 grid grid-cols-4 gap-x-12 gap-y-6 shadow-lg'>
        ...
        <button className='relative border border-blue-600 w-18 h-18 flex items-center justify-center rounded-lg border-2 hover:scale-120 duration-200'>
        ...
        <button onClick={()=>addText("title")} className='text-xl font-bold border text-rose-600 border-rose-600 w-18 h-18 flex items-center justify-center rounded-lg border-2 hover:scale-120 duration-200'>
          Title
        </button>

        <button onClick={()=>addText("subtitle")} className='text-green-400 font-semibold border border-green-400 w-18 h-18 flex items-center justify-center rounded-lg border-2 hover:scale-120 duration-200'>
          Subtitle
        </button>

        <button onClick={()=>addText("small")} className='text-sm font-medium border border-amber-400 text-amber-400 w-18 h-18 flex items-center justify-center rounded-lg border-2 hover:scale-120 duration-200'>
          Small
        </button>
        ...
        <div
          ref={divRef}
          style={{
            border: (card.image || card.title.label || card.subtitle.label || card.small.label) ? undefined : '1px solid #ccc'
          }} 
        ...
        <button onClick={download} className='bg-blue-600 p-3 flex items-center col-span-4 rounded justify-center font-medium text-white gap-2'>
          <Download />
          Download
        </button>
      </div>
