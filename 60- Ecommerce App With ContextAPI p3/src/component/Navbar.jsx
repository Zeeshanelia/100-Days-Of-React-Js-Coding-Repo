import { ChevronDown, MapPin, ShoppingCart, LogIn, MapPinned } from "lucide-react";
...

          {
            dropDown
              ...
              <div className="w-[150px]  z-50 bg-white fixed top-15 shadow-lg left-50 rounded-md ">
                ...
                <button className="text-sm bg-rose-400 rounded-lg px-1 py-1 mb-2 mx-auto cursor-pointer hover:bg-rose-500 flex justift-between items-center gap-1" onClick={getLocation}>Detect location <MapPinned /> </button>
              </div>
              : null
